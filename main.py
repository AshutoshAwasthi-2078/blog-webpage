...
mail = Mail(app)
if local_server:
    app.config["SQLALCHEMY_DATABASE_URI"] = params["local_uri"]  #'mysql://root:@localhost/kuch_bhi'
else:
...
class Contact(db.Model):
    ...
    phone_num = db.Column(db.String(12), primary_key=True, nullable=False)
...
class Posts(db.Model):
    ...
    tagline = db.Column(db.String(40), unique=False, nullable=True)
...
def dashboard():
    ...
    if request.method == 'POST':
        ...
        if username == params['admin_user'] and userpass == params['admin_pass']:
            ...
            posts=Posts.query.all()
            return render_template('dashboard.html', params=params, posts=posts)
    return render_template('login_blog.html', params=params)
